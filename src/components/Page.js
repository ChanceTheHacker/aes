...
const img1 = {
	...
	backgroundImage: 'url(http://mrmrs.github.io/photos/v/022.jpg)',
	backgroundPosition: 'center',
}
const img2 = {
	backgroundColor: 'black',
	backgroundImage: 'url(http://mrmrs.github.io/photos/v/024.jpg)',
	backgroundPosition: 'center',
}
const img3 = {
	backgroundColor: 'black',
	backgroundImage: 'url(http://mrmrs.github.io/photos/050.jpg)',
	backgroundPosition: 'left',
}
const img4 = {
	backgroundColor: 'black',
	backgroundImage: 'url(http://mrmrs.github.io/photos/049.jpg)',
	backgroundPosition: 'center',
}
const img5 = {
	backgroundColor: 'black',
	backgroundImage: 'url(http://mrmrs.github.io/photos/051.jpg)',
	backgroundPosition: 'center',
}
const img6 = {
	backgroundColor: 'black',
	backgroundImage: 'url(http://mrmrs.github.io/photos/u/001.jpg)',
	backgroundPosition: 'center',
}
const img7 = {
	backgroundColor: 'black',
	backgroundImage: 'url(http://mrmrs.github.io/photos/u/002.jpg)',
	backgroundPosition: 'center',
}
const img8 = {
	backgroundColor: 'black',
	backgroundImage: 'url(http://mrmrs.github.io/photos/u/003.jpg)',
	backgroundPosition: 'center',
}
const img9 = {
	backgroundColor: 'black',
	backgroundImage: 'url(http://mrmrs.github.io/photos/u/004.jpg)',
	backgroundPosition: 'center',
}
	...
	return ( 
		<main class="w-100 cf helvetica dark-gray bg-white pa3 pa4-m pa5-l mw9 center">
		    <div class="fl w-50 pr2 pr3-l mb3 mb4-l">
		      <div class="cover pv5 pv6-m pv7-l" style={img1}> </div>
		    </div>
		    <div class="fl w-50 w-25-l pl2 pr2-m ph2-l mb3 mb4-l">
		      <div class="cover pv5 pv6-m pv7-l" style={img2}> </div>
		    </div>
		    <div class="fl w-50 w-50 w-25-l pr2 pr0-l pl3-l mb3 mb4-l">
		      <div class="cover pv5 pv6-m pv7-l" style={img3}> </div>
		    </div>
		    <div class="fl w-50 w-50 w-25-l pl2 pl0-l pr2-m pr4-l mb3 mb4-l">
		      <div class="cover pv5 pv6-m pv7-l" style={img4}> </div>
		    </div>
		    ...
		    <div class="cf">
		      <div class="fl w-100 w-25-l pl3-l mb3 mb4-l">
		          <div class="cover pv5 pv6-m pv7-l" style={img5}> </div>
		      </div>
		      ...
		      <div class="fl w-100 w-75-l pv0 mv0">
		        <div class="fl w-100 mb2 mb4-l">
		          <div class="cover pv5 pv6-l" style={img6}> </div>
		        </div>
		        <div class="fl w-25 mb2 mb4-l">
		          <div class="cover pv5 pv6-m pv7-l" style={img7}> </div>
		        </div>
		        <div class="fl w-75 pl2 pl4-l mb2 mb4-l">
		          <div class="cover pv5 pv6-m pv7-l" style={img8}> </div>
		        </div>
		        <div class="fl w-100 mb2 mb4-l">
		            <div class="cover pv5 pv6-ns" style={img9}> </div>
		        </div>
		      </div>
		    </div>
		</main>
